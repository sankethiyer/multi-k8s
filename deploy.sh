...
kubectl set image deployments/client-deployment client=sankethiyer/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=sankethiyer/multi-worker:$SHA